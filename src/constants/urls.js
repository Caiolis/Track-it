// Url used to register new users
export const SIGN_UP = 'https://mock-api.bootcamp.respondeai.com.br/api/v2/trackit/auth/sign-up';

// Url used to login users
export const LOGIN = 'https://mock-api.bootcamp.respondeai.com.br/api/v2/trackit/auth/login';
